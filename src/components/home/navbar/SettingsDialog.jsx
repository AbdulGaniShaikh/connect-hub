...
const SettingsDialog = ({ onCloseClick = () => {}, userId = '' }) => {
  ...
  return (
    <div className="flex max-h-full flex-col bg-lightBg text-colorOnLight dark:bg-darkBg dark:text-colorOnDark rounded-t-3xl sm:rounded-3xl p-5 overflow-hidden w-full">
